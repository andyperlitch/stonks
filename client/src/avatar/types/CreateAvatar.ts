...
import { CreateAvatarInput } from "./../../../types/globalTypes";

// ====================================================
// GraphQL mutation operation: CreateAvatar
// ====================================================

export interface CreateAvatar_createAvatar_components {
...
export interface CreateAvatar_createAvatar {
   ...
   */
  components: CreateAvatar_createAvatar_components[];
  /**
...
export interface CreateAvatar {
  createAvatar: CreateAvatar_createAvatar;
}
